...
const createPreference = async (req, res) => {
  try {
    ...
    const result = await preference.create({
      body: {
        items: [{ id: booking_id, title: service_title, quantity: 1, unit_price: parseFloat(amount), currency_id: 'ARS' }],
        payer: { email: client_email },
        back_urls: { success: 'changuita://payment/success', failure: 'changuita://payment/failure', pending: 'changuita://payment/pending' },
